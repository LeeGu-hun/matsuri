...
<div id="contents">
	<c:if test="${!empty boardList }">
			<c:forEach var="boa" items="${boardList }">
				<div style="width:50%;margin-left:auto;margin-right: auto;border: 1px dashed black;text-align: center;" >
					<div class="row" style="height:50px;">
						...
						<div class="col-md-3"><fmt:formatDate value="${boa.date }" pattern="yyyy-MM-dd" /></div>
					</div>
					<div>
