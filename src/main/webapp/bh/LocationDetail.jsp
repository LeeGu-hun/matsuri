			...
			<center>
				<table class="ui very basic collapsing celled table">
					...
					<tbody>
						...
						<tr>
							<td><b>공연장 및 축제장소 세부</b></td>
							<td><a href="25.jsp" class="ui violet button, small ui button">대극장
									ㅇㅇㅇ홀</a><br> <a href="#"
								class="ui violet button, small ui button">대극장 ㅇㅇㅇ홀</a><br>
								<a href="#" class="ui violet button, small ui button">대극장
									ㅇㅇㅇ홀</a><br> <a href="#"
								class="ui violet button, small ui button">소극장 ㅇㅇㅇ홀</a><br>
							</td>
						</tr>
					</tbody>
				</table>
