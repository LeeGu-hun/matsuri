...
<script>
		...
		$(function() {
			...
			$("#from2").datepicker("option", "showAnim", "clip");
			$("#to2").datepicker("option", "showAnim", "clip");
			$("#from3").datepicker("option", "showAnim", "clip");
			$("#to3").datepicker("option", "showAnim", "clip");
			getDate();
		});
			...
			<div id="tab1" class="tabcontent current">
				<form id="thema" method="get" action="">
						<div id="thema" align="center" >
							<input type="checkbox" /> <label>연극</label> <input
								type="checkbox" /> <label>뮤지컬</label> 
								<input type="checkbox" />
							<label>축제</label>
							
								<span style="float:right">더보기<input type="button" id="add"
									onclick="themaAdd();" value="+" /></span>
						</div>
						
						
						<div id="themaAdd" align="center" style="display:none">
							<input type="checkbox" /> <label>전시회</label> <input
								type="checkbox" /> <label>발레</label> 
								<input type="checkbox" />
							<label>오페라</label>
							<br>
						...
						<div>
						<input type="text" > 
						<span style="float:right"><input type="button" onclick="search();" value="검색"> </span>
						</div>
					</form>
				</div>
				...
				<div id="tab2" class="tabcontent">
					<form method="get" action="">
						...
						<input type="text" name="from2" id="from2" /> ~ <input type="text" id="to2" />
						</div>
				...
				<div id="tab3" class="tabcontent">
					<form action="" id="team" method="get">
						...
						<input type="text" id="from3" /> ~ <input type="text" id="to3" />
						</div>
